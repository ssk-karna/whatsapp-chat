...
import com.example.whatsappchat.User.UserListAdapter;
import com.example.whatsappchat.User.UserObject;
import com.example.whatsappchat.Utils.CountryToPhonePrefix;
...
public class FindUserActivity extends AppCompatActivity {
  ...
  // private LinkedHashSet<UserObject> lhs;
...
//                                LinkedHashSet<UserObject> lhs = new LinkedHashSet<UserObject>(userList);
//                                lhs.addAll(userList);
//                                userList.clear();
//                                userList.addAll(lhs);
                            userList.add(mUser);
